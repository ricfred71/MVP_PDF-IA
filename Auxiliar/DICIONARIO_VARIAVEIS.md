...
Este documento lista os campos definidos nos schemas do projeto, com tipo e uma descrição breve do conteúdo atribuído.

## Patentes > Petição > Recurso contra Indeferimento de Pedido de Patente
Fonte: [ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/patentes/types/pet_recurso-indef/pet_schema.js](ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/patentes/types/pet_recurso-indef/pet_schema.js)
...
Fonte: [ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/marcas/types/pet_recurso-indef/pet_schema.js](ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/marcas/types/pet_recurso-indef/pet_schema.js)
...
Fonte: [ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/patentes/types/doc_recurso-indef--naoProv/doc_schema.js](ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/patentes/types/doc_recurso-indef--naoProv/doc_schema.js)
...
| `form_numeroProcesso` | string | Número do processo (formato BR + dígitos). |
...
Fonte: [ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/marcas/types/doc_recurso-indef--naoProv/doc_schema.js](ExrtensãoPatentesMarca/ExtensaoPatente-Marca/sectors/marcas/types/doc_recurso-indef--naoProv/doc_schema.js)
...
| `dataDespacho` | string | Data do despacho (DD/MM/YYYY). |
| `numeroRPI` | string | Número da RPI. |
| `tipoDespacho` | string | Tipo de despacho (Recurso não provido). |
| `codigoDespacho` | string | Código do despacho. |
| `textoDespacho` | string | Texto do despacho. |
| `fundamentosLegais` | array | Lista de fundamentos legais citados. |
